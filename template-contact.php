    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        ...
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase"><?php $contact_subtitle; ?></h5>
                <h1 class="mb-0"><?php $contact_title; ?></h1>
            </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                    <?php echo do_shortcode('[contact-form-7 id="cbbeaf4" title="Contact Form"]'); ?>
                </div>
...
<?php
    ...
    get_template_part('demo-data/template-contact');
}
?>