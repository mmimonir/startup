...
function startup_footer_address_widget_load()
{
    register_widget('startup_footer_address_widget');
}

add_action('widgets_init', 'startup_footer_address_widget_load');
